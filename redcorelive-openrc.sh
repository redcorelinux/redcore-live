...
redcore_live_user_groups() {
	for group in tty disk lp lpadmin wheel uucp console audio cdrom tape kvm cdemu games video vboxsf vboxguest cdrw usb plugdev messagebus portage smbshare ; do
